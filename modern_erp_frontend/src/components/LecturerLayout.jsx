...
const LecturerLayout = () => {
  ...
  const menuItems = [
    { path: "/lecturer/dashboard", icon: "fas fa-home", label: "Dashboard" },
    { path: "/lecturer/courses", icon: "fas fa-book", label: "My Courses" },
    { path: "/lecturer/communications", icon: "fas fa-envelope", label: "Student Communications" },
    { path: "/lecturer/profile", icon: "fas fa-user", label: "My Profile" },
  ];
    ...
    <div className="flex flex-col md:flex-row gap-6 mt-6">
      ...
      >
        <div className="p-4 flex items-center">
          <i className="fas fa-chalkboard-teacher text-2xl text-blue-600"></i>
          <span className="ml-3 text-xl font-bold">Lecturer Portal</span>
        </div>
        
        {/* User info and logout - UPDATED with text label */}
        <div className="p-4 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-medium text-gray-800">{userName || username || 'Lecturer'}</p>
