...
const StudentLayout = () => {
  ...
  const menuItems = [
    { path: "/student/courses", icon: "fas fa-home", label: "My Courses" },
    { path: "/student/enroll", icon: "fas fa-book", label: "Enroll Courses" },
    { path: "/student/results", icon: "fas fa-chart-bar", label: "View Results" },
    { path: "/student/profile", icon: "fas fa-user", label: "My Profile" },
  ];
    ...
    <div className="flex flex-col md:flex-row gap-6 mt-6">
      ...
      >
        <div className="p-4 flex items-center">
          ...
          <span className="ml-3 text-xl font-bold">Student Portal</span>
        </div>
        ...
        <div className="p-4 border-b border-gray-100">
          <div className="flex flex-col space-y-3">
            <div>
              <p className="font-medium text-gray-800">{userName || username || 'Student'}</p>
